...
- welcher Student hat Schwierigkeiten oder wird in Zukunft welche haben
...
=== Ausgangssituation
Das QIS‑Portal stellt nur eine einzelne Notentabelle pro Studierendem dar.
...
=== Motivation
Im Projektseminar wurde uns die Aufgabe gegeben, ein System zu entwickeln, das diese Lücke schließt.
...
Gleichzeitig soll das System auch die Fakultätsleitung und den Dekan entlasten, indem es verlässliche, übersichtliche und vergleichbare Daten für Entscheidungen bereitstellt.
...
Die Transformation der Daten erfolgt mit dbt. 
dbt übernimmt: 
...
- die konsistente Benennung der KPI-Modelle 
- die Materialisierung der KPI-Tabellen für bessere Performance
- sowie Teile der technischen Dokumentation und Tests


include::Dokumentation der dbt-staging-Modelle.adoc[leveloffset=+2, tags="staging_kurz"]
==== Tests
include::Dokumentation der dbt-staging-Modelle.adoc[leveloffset=+2, tags="test1"]
include::Dokumentation der dbt-staging-Modelle.adoc[leveloffset=+2, tags="test"]

include::Dokumentation der dbt-staging-Modelle.adoc[leveloffset=+2, tags="fazit"]


=== Analytisches Datenmodell (Star Schema)
include::galaxy_schema.adoc[leveloffset=+2, tags="zielsetzung"]
include::galaxy_schema.adoc[leveloffset=+2, tags="facts_dims"]
...
=== Seeding (dbt)
include::Dokumentaion dbt-seeding.adoc[leveloffset=+2, tags=seeding_kurz]

==== Fazit
Seeding stellt sicher, dass wichtige Stammdaten zuverlässig und immer in derselben Version vorliegen. Dadurch können Staging‑Modelle und KPI‑Berechnungen auf einer sauberen und stabilen Datenbasis aufbauen.
...
Siehe <<Strukturfact_kpi,Struktur der Faktentabelle>> im Anhang.
...
Siehe <<Strukturdim,Strukturen der Dimensionen>> im Anhang.
...
==== Dimensionen und Fakttabllen
[[Strukturfact_kpi]] *Struktur der fact_kpi:*

image::Bilder/fact_kpi.png[width=80%] 

[[Strukturdim]] *Struktur der dim_student:*  

image::Bilder/dim_students.png[width=80%] 

*Struktur der dim_modul:*

image::Bilder/dim_modul.png[width=80%] 

*Struktur der dim_zeit:*

image::Bilder/dim_zeit.png[width=80%]
